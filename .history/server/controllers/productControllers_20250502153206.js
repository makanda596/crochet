...
export const createProduct = async (req, res) => {
    const { title, description, price, image, optionalImage1, optionalImage2 } = req.body;
    ...
    try {
        ...
        let optionalImageUrl1 = "";
        let optionalImageUrl2 = "";

        if (optionalImage1) {
            const upload1 = await cloudinary.uploader.upload(optionalImage1);
            optionalImageUrl1 = upload1.secure_url;
        }

        if (optionalImage2) {
            const upload2 = await cloudinary.uploader.upload(optionalImage2);
            optionalImageUrl2 = upload2.secure_url;
        }
        ...
        const newProduct = new Product({
            ...
            price,
            image: imageUrl,
            optionalImage1: optionalImageUrl1,
            optionalImage2: optionalImageUrl2,
        });
