...
import Admin from '../models/AdminModel'; // Ensure correct path to Admin model
...
export const createProduct = async (req, res) => {
    ...
    try {
        ...
        const newProduct = new Product({
            ...
            price,
            image: imageUrl,
            createdBy: req.admin.id, // Optionally track who created the product
        });
...
export const createFlash = async (req, res) => {
    ...
    try {
        ...
        const newFlashSaleItem = new FlashSale({
            ...
            price,
            image: imageUrl,
            createdBy: req.admin.id, // Optionally track who created the flash sale item
        });
