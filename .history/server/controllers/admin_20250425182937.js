...
import Admin from '../models/AdminModel'; // Assuming you have an Admin model
import User from '../models/UserModel'; // Assuming you have a User model (for update)

// Utility function to generate JWT token
const generateToken = (id) => {
    return jwt.sign({ id }, process.env.JWT_SECRET, { expiresIn: '20mins' });
};
