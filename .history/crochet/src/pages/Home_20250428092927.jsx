...
const TABS = [
  ...
  { id: 'postflash', label: 'post flash', icon: '✍️' },
...
const Home = () => {
  ...
  const renderContent = () => {
    ...
    switch (activeTab) {
      ...
      case 'postflash': return <PostFlash />;
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <main className="flex-1 p-2 lg:p-8">
          ...
          <div className="hidden lg:flex items-center justify-between mb-2">
            <div className="flex items-center space-x-4 bg-white px-2 py-2 rounded-lg shadow-sm w-96">
