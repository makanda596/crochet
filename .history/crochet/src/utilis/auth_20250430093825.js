...
export const useAuthStore = create((set)=>({
    ...
    checkAuth: async () => {
        ...
        try {
            ...
            const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/admin/check-auth`, {
    ...
    getProducts: async () => {
        try {
            ...
            const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/products/allproducts`);
    ...
    getflashsales: async () => {
        try {
            set({ loading: true, error: null });
            const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/products/allflashsales`);
    ...
    getOrders: async () => {
        try {
            set({ loading: true });
            const token = localStorage.getItem("token");
            const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/orders/getorders`, {
                headers: { Authorization: `Bearer ${token}` }
            });
     ...
     profile : async () => {
        try {
            ...
            // Assuming you're using React's useState to set state, update it with the response data
