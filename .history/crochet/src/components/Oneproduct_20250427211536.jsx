            ...
            <div className="lg:w-1/2 p-4">
              ...
              <div className="flex flex-row gap-2">
                <button
                  ...
                  className="w-32 h-2 bg-green-500 hover:bg-green-600 text-white py-1 px-4 rounded-lg font-medium transition-colors flex items-center justify-center"
                >
                  Order 
                </button>

                <button 
                  className="w-32 bg-blue-500 hover:bg-green-600 text-white py-1 px-4 rounded-lg font-medium transition-colors flex items-center justify-center"
