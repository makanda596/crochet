        ...
        <div className="max-w-7xl mx-auto">
          ...
          {loading ? (
            <div className="rounded-xl shadow-xl overflow-hidden lg:flex">
              ...
              <div className="lg:w-1/2 p-2 space-y-4">
            ...
            <div className="rounded-xl shadow-xl overflow-hidden lg:flex bg-white">
              {/* Image Gallery */}
              <section className="lg:w-1/2 p-2" aria-label="Product images">
                ...
                {product.images.length > 0 && (
                  <div className="grid grid-cols-4 gap-0 mt-[-50px]">
                    {product.images.map((img, index) => (
                      <button
                        key={index}
                        onClick={() => setMainImage(img)}
                        className={`aspect-square rounded-lg border-2 h-12 w-12 overflow-hidden transition-all ${mainImage === img
