    ...
    <Link
      ...
      <div className="p-2 space-y-2">
        ...
        <Link
          ...
          className="flex items-center justify-center gap-2 w-full bg-purple-600 hover:bg-purple-700 text-white py-1 rounded-lg font-medium transition-colors duration-200"
        >
