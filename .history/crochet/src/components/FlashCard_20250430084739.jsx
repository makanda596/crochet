...
const FlashCard = ({ product }) => {
  ...
  return (
    <Link
      to={`/OneFlash/${product._id}`}
      className="flex flex-col rounded-lg shadow-md overflow-hidden hover:shadow-lg transition"
    >
      {/* Image Section */}
      <img
      ...
      <div className="flex-1 p-2 flex flex-col justify-between">
        ...
        <div className="mt-2 space-y-1">
          ...
          {discount > 0 && (
            <span className="text-xs text-white bg-red-500 px-2 py-0.5 rounded-full inline-block">
              -{discount}%
            </span>
          )}
        </div>
