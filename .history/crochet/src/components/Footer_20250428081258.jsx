...
const Footer = () => {
  return (
    <footer className="bg-purple-900 text-white pt-12 pb-2 mt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold">CrochetCraft</span>
            </div>
            <p className="text-purple-200 text-sm">
              Handmade with love and natural materials. Creating beautiful crochet items since 2020.
            </p>
