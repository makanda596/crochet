        ...
        <div className="flex flex-wrap gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl w-64 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all"
            />
          </div>
          <select
            value={statusFilter}
