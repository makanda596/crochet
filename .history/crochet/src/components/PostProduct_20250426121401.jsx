...
const CreatePost = () => {
  ...
  return (
    <div className=" ml-6 lg:ml-96 inset-0 bg-opacity-100 flex items-center w-full justify-center p-2 z-50">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md max-h-[90vh] ">
        <div className="sticky top-0 bg-white p-2 border-b border-gray-200 flex justify-between items-center">
          <h2 className="text-md font-bold text-gray-800">Create New Listing</h2>
