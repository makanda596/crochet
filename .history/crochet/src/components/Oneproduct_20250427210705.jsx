    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden lg:flex">
          {/* Product Image */}
          <div className="w-full lg:w-1/2 p-0 md:p-8 flex items-center justify-center">
            <img
              src={product.image || '/placeholder-crochet.jpg'}
              alt={product.title}
              className="w-full max-h-[600px] object-contain rounded-t-lg lg:rounded-l-lg lg:rounded-t-none"
            />
          </div>
