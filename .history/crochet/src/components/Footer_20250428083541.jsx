        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2 mb-2">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/about" className="text-purple-200 hover:text-white transition-colors">Shop</a></li>
              <li><a href="/enquiry" className="text-purple-200 hover:text-white transition-colors">Patterns</a></li>
