...
const ProductCard = ({ product }) => {
  ...
  return (
    <article className="group relative border-2 border-gray-300 bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-200 ease-out hover:-translate-y-0.5 overflow-hidden max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl w-full">
      {/* Image Section */}
