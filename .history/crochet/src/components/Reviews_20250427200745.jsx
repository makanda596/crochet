...
const ReviewSection = () => {
  ...
  const reviews = [
    ...
    },
    {
      ...
      rating: 4,
      date: '2024-02-20',
      comment: 'The crochet scarf is perfect! The color is exactly as shown. The only issue was the packaging—it could have been better.',
      businessType: 'crochet',
      tags: ['Scarf', 'Packaging Issue']
    },
    {
      id: 6,
      user: 'Laura F.',
      rating: 5,
      date: '2024-02-12',
      comment: 'I love the crochet shawl I bought! The craftsmanship is superb, and it feels so cozy. Highly recommend this seller.',
      businessType: 'crochet',
      tags: ['Shawl', 'Quality']
    },
    {
      ...
      rating: 2,
      date: '2024-02-10',
      comment: 'Not impressed. The crochet item I ordered wasn’t as expected. It felt a bit too flimsy, and the color wasn’t quite right.',
      businessType: 'crochet',
      tags: ['Flimsy', 'Color Issue']
    },
    {
      id: 8,
      user: 'Olivia B.',
      rating: 4,
      date: '2024-02-05',
      comment: 'Good haircut, but the stylist was a little rushed. I still love the result, but I wish they had spent more time on my style.',
      businessType: 'salon',
      tags: ['Haircut', 'Fast Service']
    }
  ];
