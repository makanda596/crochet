      ...
      <div className="max-w-7xl mx-auto">
        ...
        {product ? (
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden lg:flex">
            ...
            {/* Product Details */}
            <div className="lg:w-1/2 p-8">
              <h1 className="text-lg font-bold text-gray-900 mb-4">{product.title}</h1>
              ...
              <div className="mb-6 flex items-center">
                <span className="font-medium text-gray-700 mr-4">Availability: <span className='bg-green-500 rounded-lg text-white p-2'>In Stock</span></span>
