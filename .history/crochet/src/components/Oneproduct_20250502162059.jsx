...
const Oneproduct = () => {
  ...
  const fetchProduct = async () => {
    try {
      ...
      setMainImage(response.data.image); // Set the first image as the main image
      setLoading(false);
    } catch (err) {
    ...
    <div>
      ...
      <div className="min-h-screen py-14 px-0 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          {product ? (
            <div className="rounded-xl shadow-xl overflow-hidden lg:flex">
              ...
              <div className="lg:w-1/2 p-0 md:p-8">
                <img
                  src={mainImage || '/placeholder-crochet.jpg'}
                  alt={product.title}
              ...
              <div className="lg:w-1/2 p-4 md:mt-10">
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <button
                    className="w-32 h-8 bg-blue-500 hover:bg-green-600 text-white py-1 px-4 rounded-lg font-medium transition-colors flex items-center justify-center"
                  >
                    Add to Cart
                  </button>
                </div>
          ...
          {product.optionalImages && Array.isArray(product.optionalImages) && product.optionalImages.length > 0 && (
            <div className="mt-6">
